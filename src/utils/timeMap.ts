...
export const PROFESSIONAL_YEARS: ProfessionalYear[] = [
  'I Professional',
  'II Professional',
  'III Professional'
];

export function normalizeProfessionalYear(value: unknown): ProfessionalYear {
  return PROFESSIONAL_YEARS.includes(value as ProfessionalYear)
    ? value as ProfessionalYear
    : 'III Professional';
}
...
export function normalizeUserProfile(profile: UserProfile): UserProfile {
  return {
    ...profile,
    professionalYear: normalizeProfessionalYear(profile.professionalYear),
